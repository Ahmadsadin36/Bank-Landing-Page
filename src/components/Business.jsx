    ...
    <div className='flex flex-col items-center justify-start w-full '>
      <div className='grid grid-cols-1 gap-4'>
        {features.map((feature, index) => (
          <div key={index} className='flex items-center justify-start flex-row rounded-xl transition-all duration-300 hover:bg-gray-800 p-2'>
...
const Business = () => {
  return (
    <section className=' container p-3 m-auto mt-8 flex flex-col md:flex-row items-center justify-start' id='features'>
